        ...
        const defaultRoles = [
            {
                ...
                permissions: 'crm.view_all,crm.view_agency,crm.view_own,crm.create,crm.edit_technical,crm.validate_doc,crm.delete,crm.assign,finance.view_global,finance.view_agency,finance.payout,network.manage,fleet.manage,users.manage,roles.manage,settings.manage,automations.manage,inbox.view,inbox.send,profile.view_own,profile.edit_own,profile.view_team',
                isSystem: true,
            },
            {
                id: 'HQ_ADMIN',
                ...
                permissions: 'crm.view_all,crm.view_agency,crm.view_own,crm.create,crm.edit_technical,crm.validate_doc,crm.assign,finance.view_global,finance.view_agency,network.manage,fleet.manage,users.manage,inbox.view,inbox.send,profile.view_own,profile.edit_own,profile.view_team',
                isSystem: true,
            },
            {
                id: 'CASE_WORKER',
                ...
                permissions: 'crm.view_all,crm.view_agency,crm.view_own,crm.create,crm.edit_technical,crm.validate_doc,crm.assign,inbox.view,inbox.send,profile.view_own,profile.edit_own,profile.view_team',
                isSystem: true,
            },
            {
                id: 'AGENCY_MANAGER',
                label: 'Manager Agence',
                description: 'Gestion des leads de l\'agence, suivi des commissions, communication client et dispatch aux commerciaux. Pas de traitement juridique (réservé au siège).',
                permissions: 'crm.view_agency,crm.view_own,crm.create,crm.assign,finance.view_agency,inbox.view,inbox.send,profile.view_own,profile.edit_own,profile.view_team',
                isSystem: true,
            },
            {
                id: 'SALES',
